...
nimbuild <- init.SMR.Dcov.mobileAC.Open.Generalized(data,inits,M=M,x.vals.edges=x.vals.edges,
...
#                                  n.marked.all=nimbuild$n.marked.all,mark.states=nimbuild$mark.states[i,],mark.states.all=nimbuild$mark.states,
