  ...
  run = function(){
    ...
    for(i in (n.cap.all+1):M){
      if(model$z.super[i]==1){
        ...
        lp.initial.total <- lp.initial.entry + lp.initial.y.mark + lp.initial.y.um + lp.initial.y.unk +
          lp.initial.trap.RE + lp.initial.surv + lp.initial.tel.z.states + log.prior.curr
        lp.proposed.total <- lp.proposed.entry + lp.proposed.y.mark + lp.proposed.y.um + lp.proposed.y.unk +
          lp.proposed.trap.RE + lp.proposed.surv + lp.proposed.tel.z.states + log.prior.prop
      ...
      if(updown==0){#subtract
        ...
        if(!reject){
          ...
          lp.initial.total <- lp.initial.N + lp.initial.y.mark + lp.initial.y.um + lp.initial.y.unk +
            lp.initial.trap.RE + lp.initial.N.recruit + lp.initial.surv + lp.initial.tel.z.states + lp.initial.s
          lp.proposed.total <- lp.proposed.N + lp.proposed.y.mark + lp.proposed.y.um + lp.proposed.y.unk +
            lp.proposed.trap.RE + lp.proposed.N.recruit + lp.proposed.surv + lp.proposed.tel.z.states + lp.proposed.s
