...
nimbuild <- init.SMR.Dcov.mobileAC.Open.Generalized.Interspersed(data,inits,M=M,x.vals.edges=x.vals.edges,
...
conf$addSampler(target=c("z"),
                ...
                control=list(M=M,n.marked.all=n.marked.all,n.cap.all=n.cap.all,
                             ...
                             avail.z=avail.z,cells=cells.double,dSS=dSS,n.cells=n.cells,
