...
data <- sim.JS.SMR.Dcov.mobileAC.Generalized.Interspersed(D.beta0=D.beta0,D.beta1=D.beta1,D.cov=D.cov,tau=tau,
...
#                                  J.mark=J.mark,J.sight=J.sight,K.sight=K.sight,
#                                  n.marked.all=nimbuild$n.marked.all,mark.states=nimbuild$mark.states[i,,],
